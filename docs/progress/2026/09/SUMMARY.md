...
| Sep 24 | **methodology** "How this is counted" page ships: one code-first registry (8 sections + 13 metric docs) read by the page and every `app-info-popover`; shared popover fixes 5 a11y defects; `app-disclaimer-note`; PR-template anti-drift checklist; the disclaimer's schedule-derived rail sentence was later dropped (`6727641`) since the tracker shows live GTFS data                                                         |
