...
const CHIP_STYLE: Record<string, { active: string; inactive: string }> = {
  ...
  IN_SERVICE: {
    ...
    inactive:
      "bg-emerald-50 text-emerald-800 border-emerald-200 hover:bg-emerald-100 dark:bg-emerald-950/40 dark:text-emerald-300 dark:border-emerald-900",
  },
  NOT_SPOTTED: {
  ...
  DECOMMISSIONED: {
    ...
    inactive:
      "bg-neutral-50 text-neutral-700 border-neutral-200 hover:bg-neutral-100 dark:bg-neutral-900 dark:text-neutral-300 dark:border-neutral-800",
  },
  MARRIED: {
    active: "bg-purple-600 text-white border-transparent",
    inactive:
      "bg-purple-50 text-purple-800 border-purple-200 hover:bg-purple-100 dark:bg-purple-950/40 dark:text-purple-300 dark:border-purple-900",
  },
  TESTING: {
