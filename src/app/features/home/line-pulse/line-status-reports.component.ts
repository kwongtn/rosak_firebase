...
/**
 * The expanded line card's recent community reports: each row is the passenger-status badge, how
 * long ago it was filed, an optional delay and the reporter's notes. Only the first page of
