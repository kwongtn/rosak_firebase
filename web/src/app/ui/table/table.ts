...
@Directive({ selector: "div[hlmTableContainer]", host: { class: "relative w-full overflow-x-auto" } })
...
@Directive({
    selector: "th[hlmTh]",
    host: { class: "text-foreground h-10 px-2 text-start align-middle font-medium whitespace-nowrap" },
})
export class HlmTh {}
...
export const HlmTableImports = [HlmTableContainer, HlmTable, HlmTHead, HlmTBody, HlmTr, HlmTh, HlmTd] as const;
