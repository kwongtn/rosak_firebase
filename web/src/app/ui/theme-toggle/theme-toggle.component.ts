...
@Component({
    ...
    template: `
        ...
        <button
            ...
            [title]="'Theme: ' + MODE_LABEL[theme.mode()] + ' — click to switch to ' + MODE_LABEL[nextMode()]"
            (click)="theme.cycle()"
        ...
        >
            @switch (theme.mode()) {
                @case ("light") {
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" class="size-4 shrink-0" aria-hidden="true">
