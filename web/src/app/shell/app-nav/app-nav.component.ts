...
@Component({
    ...
    template: `
        <div #brandRow class="flex items-center justify-between gap-2 px-4 py-3 sm:gap-4 sm:px-6 lg:px-8">
                ...
                >
                    @if (_navLinksFit()) {
                        ...
                        >
                            ...
                            <svg viewBox="0 0 24 24" class="size-3.5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
                        ...
                        @if (_hoverCapable()) {
                            ...
                            <hlm-sheet [open]="moduleMenuOpen()" (openChange)="moduleMenuOpen.set($event)" side="bottom">
            ...
            <div class="flex shrink-0 items-center gap-2">
                ...
                @if (uploads.pendingCount() > 0) {
                    ...
                    >
                        <svg class="size-3 shrink-0 animate-spin" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                ...
                >
                    @if (auth.isLoggedIn() && avatarUrl() && !avatarErrored()) {
                        <img [src]="avatarUrl()" alt="" class="size-5 shrink-0 rounded-full object-cover" (error)="avatarErrored.set(true)" />
                    } @else {
                        <svg viewBox="0 0 24 24" class="size-5 shrink-0" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                            <path
                                stroke-linecap="round"
    ...
    constructor() {
        ...
        effect(() => {
            ...
            if (pending === 0 && wasUploading) {
                this.toast.success("Uploads complete", "All your photos have been uploaded — you can close this tab now.");
            }
