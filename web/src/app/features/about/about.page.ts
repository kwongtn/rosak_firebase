...
@Component({
    selector: "app-about",
    imports: [HlmBadge, HlmButton, HlmSkeleton, AppNavComponent, AppFooterComponent, ...HlmCardImports],
...
export class AboutPage implements OnDestroy {
    ...
    protected readonly projects = computed(() => (this._data()?.projects ?? []).filter((p) => p.display));
