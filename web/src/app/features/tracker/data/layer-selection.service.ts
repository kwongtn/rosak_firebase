...
export class LayerSelectionService {
    ...
    readonly realtimeCount = computed(() => Object.values(this.realtimeChecked()).filter(Boolean).length);
    ...
    readonly selectedCount = computed(() => this.realtimeCount() + this.stopsCount() + this.railwayCount());
