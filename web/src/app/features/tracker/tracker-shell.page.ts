...
@Component({
    ...
    imports: [RouterLink, TrackerMapComponent, StatusCardComponent, MobileLayerSheetComponent, ThemeToggleComponent],
    template: `
        <div class="relative h-screen w-screen overflow-hidden">
            ...
            <div class="bg-background/90 absolute top-3 left-3 z-10 flex max-w-[calc(100vw-5rem)] flex-col rounded-lg px-3 py-1.5 text-sm shadow sm:max-w-[calc(100vw-1.5rem)]">
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <a routerLink="/spotting" class="text-muted-foreground hover:text-foreground hidden sm:inline">TranSPOT</a>
                    <a routerLink="/insiden" class="text-muted-foreground hover:text-foreground hidden sm:inline">Insiden</a>
                    <a routerLink="/profile" class="text-muted-foreground hover:text-foreground hidden sm:inline">Profile</a>
                    <a routerLink="/about" class="text-muted-foreground hover:text-foreground hidden sm:inline">About</a>
                ...
                @if (navExpanded()) {
                    <div class="mt-2 flex flex-col gap-2 border-t pt-2 sm:hidden">
                        <a routerLink="/spotting" class="text-muted-foreground hover:text-foreground" (click)="navExpanded.set(false)">TranSPOT</a>
                        <a routerLink="/insiden" class="text-muted-foreground hover:text-foreground" (click)="navExpanded.set(false)">Insiden</a>
                        <a routerLink="/profile" class="text-muted-foreground hover:text-foreground" (click)="navExpanded.set(false)">Profile</a>
                        <a routerLink="/about" class="text-muted-foreground hover:text-foreground" (click)="navExpanded.set(false)">About</a>
                    </div>
                }
            </div>
...
export class TrackerShellPage implements OnDestroy {
    ...
    private feedbackDialog: Awaited<ReturnType<Exclude<ReturnType<typeof Sentry.getFeedback>, undefined>["createForm"]>> | null = null;
