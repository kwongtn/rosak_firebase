import { Component, computed, DestroyRef, ElementRef, PLATFORM_ID, effect, inject, input, signal, viewChild } from "@angular/core";
...
import { VEHICLE_TYPES_QUERY, VehicleTypesQueryData, VehicleTypesQueryVars } from "../data/spotting.queries";
    ...
    template: `
        <div class="flex flex-col gap-6">
            <div class="flex items-center justify-between gap-2 sm:hidden">
                ...
                <a [routerLink]="['/spotting', lineId(), 'details']" hlmBtn variant="outline" size="sm">Details</a>
            </div>
