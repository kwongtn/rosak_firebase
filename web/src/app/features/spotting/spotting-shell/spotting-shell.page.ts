...
@Component({
    ...
    imports: [RouterOutlet, HlmButton, HlmSheet, HlmSheetHeader, HlmSheetBody, HlmSheetFooter, AppNavComponent, AppFooterComponent, ReportFormComponent],
    template: `
        <app-nav />
        ...
        <hlm-sheet [open]="reportSheet.isOpen()" (openChange)="reportSheet.setOpen($event)" side="right">
            <div hlmSheetHeader>
