...
export const SPOTTING_ROUTES: Routes = [
    {
        ...
        loadComponent: () => import("./spotting-shell/spotting-shell.page").then((m) => m.SpottingShellPage),
        children: [
            {
                path: "",
            ...
            {
                path: ":lineId",
                loadComponent: () => import("./line-overview/line-overview.page").then((m) => m.LineOverviewPage),
            },
            {
                path: ":lineId/details",
                loadComponent: () => import("./line-details/line-details.page").then((m) => m.LineDetailsPage),
            },
            {
