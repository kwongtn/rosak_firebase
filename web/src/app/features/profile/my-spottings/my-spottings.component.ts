...
@Component({
    ...
    imports: [DatePipe, HlmButton, HlmSkeleton, ...HlmCardImports, HlmSheet, HlmSheetHeader, HlmSheetBody, VehicleStatusBadge, SpottingTypeBadge],
    template: `
        <div hlmCard>
            ...
            <div hlmCardContent>
                @if (_events().length === 0 && _isLoading()) {
                                        ...
                                        <li class="flex items-center justify-between gap-2">
                                            <div class="flex flex-wrap items-center gap-2">
                                                ...
                                                <span class="text-muted-foreground text-xs">
                                                    {{ event.vehicle.identificationNo }} ({{ event.vehicle.vehicleType.internalName }})
                    ...
                    @if (_hasMore()) {
                        <button hlmBtn variant="outline" size="sm" class="mt-3 self-start" [disabled]="_isLoading()" (click)="loadMore()">
        ...
        <hlm-sheet [open]="_modalEvent() !== null" (openChange)="onModalOpenChange($event)" side="bottom">
...
export class MySpottingsComponent {
    ...
    async loadMore(): Promise<void> {
        ...
        try {
            ...
            this.toast.error("Couldn't load your spottings", err instanceof Error ? err.message : "Unknown error");
        } finally {
